...
class AnimartrixUsermod : public Usermod {
  ...
  public:
    ...
    void setup() {
      ...
      strip.addEffect(201, &mode_Module_Experiment10, _data_FX_mode_Module_Experiment10);
      strip.addEffect(202, &mode_Module_Experiment9, _data_FX_mode_Module_Experiment9);
      strip.addEffect(203, &mode_Module_Experiment8, _data_FX_mode_Module_Experiment8);
      strip.addEffect(204, &mode_Module_Experiment7, _data_FX_mode_Module_Experiment7);
      strip.addEffect(205, &mode_Module_Experiment6, _data_FX_mode_Module_Experiment6);
      strip.addEffect(206, &mode_Module_Experiment5, _data_FX_mode_Module_Experiment5);
      strip.addEffect(207, &mode_Module_Experiment4, _data_FX_mode_Module_Experiment4);
      strip.addEffect(208, &mode_Zoom2, _data_FX_mode_Zoom2);
      strip.addEffect(209, &mode_Module_Experiment3, _data_FX_mode_Module_Experiment3);
      strip.addEffect(210, &mode_Module_Experiment2, _data_FX_mode_Module_Experiment2);
      strip.addEffect(211, &mode_Module_Experiment1, _data_FX_mode_Module_Experiment1);
      strip.addEffect(212, &mode_Parametric_Water, _data_FX_mode_Parametric_Water);
      strip.addEffect(213, &mode_Water, _data_FX_mode_Water);
      strip.addEffect(214, &mode_Complex_Kaleido_6, _data_FX_mode_Complex_Kaleido_6);
      strip.addEffect(215, &mode_Complex_Kaleido_5, _data_FX_mode_Complex_Kaleido_5);
      strip.addEffect(216, &mode_Complex_Kaleido_4, _data_FX_mode_Complex_Kaleido_4);
      strip.addEffect(217, &mode_Complex_Kaleido_3, _data_FX_mode_Complex_Kaleido_3);
      strip.addEffect(218, &mode_Complex_Kaleido_2, _data_FX_mode_Complex_Kaleido_2);
      strip.addEffect(219, &mode_Complex_Kaleido, _data_FX_mode_Complex_Kaleido);
      strip.addEffect(220, &mode_SM10, _data_FX_mode_SM10);
      strip.addEffect(221, &mode_SM9, _data_FX_mode_SM9);
      strip.addEffect(222, &mode_SM8, _data_FX_mode_SM8);
      // strip.addEffect(223, &mode_SM7, _data_FX_mode_SM7);
      strip.addEffect(224, &mode_SM6, _data_FX_mode_SM6);
      strip.addEffect(225, &mode_SM5, _data_FX_mode_SM5);
      strip.addEffect(226, &mode_SM4, _data_FX_mode_SM4);
      strip.addEffect(227, &mode_SM3, _data_FX_mode_SM3);
      strip.addEffect(228, &mode_SM2, _data_FX_mode_SM2);
      strip.addEffect(229, &mode_SM1, _data_FX_mode_SM1);
      strip.addEffect(230, &mode_Big_Caleido, _data_FX_mode_Big_Caleido);
      strip.addEffect(231, &mode_RGB_Blobs5, _data_FX_mode_RGB_Blobs5);
      strip.addEffect(232, &mode_RGB_Blobs4, _data_FX_mode_RGB_Blobs4);
      strip.addEffect(233, &mode_RGB_Blobs3, _data_FX_mode_RGB_Blobs3);
      strip.addEffect(234, &mode_RGB_Blobs2, _data_FX_mode_RGB_Blobs2);
      strip.addEffect(235, &mode_RGB_Blobs, _data_FX_mode_RGB_Blobs);
      strip.addEffect(236, &mode_Polar_Waves, _data_FX_mode_Polar_Waves);
      strip.addEffect(237, &mode_Slow_Fade, _data_FX_mode_Slow_Fade);
      strip.addEffect(238, &mode_Zoom, _data_FX_mode_Zoom);
      strip.addEffect(239, &mode_Hot_Blob, _data_FX_mode_Hot_Blob);
      strip.addEffect(240, &mode_Spiralus2, _data_FX_mode_Spiralus2);
      strip.addEffect(241, &mode_Spiralus, _data_FX_mode_Spiralus);
      strip.addEffect(242, &mode_Yves, _data_FX_mode_Yves);
      strip.addEffect(243, &mode_Scaledemo1, _data_FX_mode_Scaledemo1);
      strip.addEffect(244, &mode_Lava1, _data_FX_mode_Lava1);
      strip.addEffect(245, &mode_Caleido3, _data_FX_mode_Caleido3);
      strip.addEffect(246, &mode_Caleido2, _data_FX_mode_Caleido2);
      strip.addEffect(247, &mode_Caleido1, _data_FX_mode_Caleido1);
      strip.addEffect(248, &mode_Distance_Experiment, _data_FX_mode_Distance_Experiment);
      strip.addEffect(249, &mode_Center_Field, _data_FX_mode_Center_Field);
      strip.addEffect(250, &mode_Waves, _data_FX_mode_Waves);
      strip.addEffect(251, &mode_Chasing_Spirals, _data_FX_mode_Chasing_Spirals);
      strip.addEffect(252, &mode_Rotating_Blob, _data_FX_mode_Rotating_Blob);
